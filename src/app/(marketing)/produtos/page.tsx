        ...
        <div className="container px-4 md:px-8 max-w-screen-xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto font-light">
              Escolha entre mensagens personalizadas, uma jornada emocional de 12 cartas ou uma revelação de sexo interativa.
              Todas as opções combinam fotos, músicas e mensagens personalizadas.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 border-2 border-primary/10 hover:border-primary/30 transition-all duration-300 hover:shadow-xl">
                ...
                <div className="mt-8 pt-6 border-t border-primary/10">
                  {prices['message']?.priceFromFormatted && (
                    <p className="text-lg text-muted-foreground line-through">{prices['message'].priceFromFormatted}</p>
                  )}
                  <p className="text-3xl font-bold text-primary">
                    {loading ? "..." : prices['message']?.priceFormatted || "R$ 19,90"}
                  </p>
              ...
              <div className="bg-white rounded-2xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-300 hover:shadow-xl relative overflow-hidden">
                ...
                <div className="mt-8 pt-6 border-t border-primary/10">
                  {prices['card-collection']?.priceFromFormatted && (
                    <p className="text-lg text-muted-foreground line-through">{prices['card-collection'].priceFromFormatted}</p>
                  )}
                  <p className="text-3xl font-bold text-primary">
                    {loading ? "..." : prices['card-collection']?.priceFormatted || "R$ 29,90"}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">Pagamento único</p>
                </div>
              </div>
              ...
              {/* Revelação Virtual */}
              <div className="bg-white rounded-2xl p-8 border-2 border-blue-200 hover:border-pink-300 transition-all duration-300 hover:shadow-xl relative overflow-hidden">
                <div className="absolute top-4 right-4 bg-gradient-to-r from-blue-500 to-pink-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                  NOVO
                </div>
                <h3 className="text-2xl font-bold text-text-main mb-4">Revelação Virtual</h3>
                <p className="text-muted-foreground mb-6">
                  Revele o sexo do bebê de forma interativa
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl">✓</span>
                    <span className="text-text-main">Votação interativa</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-blue-500 text-xl">✓</span>
                    <span className="text-text-main">Dashboard de votos</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl">✓</span>
                    <span className="text-text-main">Galeria com até 5 fotos</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-blue-500 text-xl">✓</span>
                    <span className="text-text-main">QR Code exclusivo</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl">✓</span>
                    <span className="text-text-main">Mensagens dos convidados</span>
                  </li>
                </ul>
                <div className="mt-8 pt-6 border-t border-primary/10">
                  {prices['gender-reveal']?.priceFromFormatted && (
                    <p className="text-lg text-muted-foreground line-through">{prices['gender-reveal'].priceFromFormatted}</p>
                  )}
                  <p className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent">
                    {loading ? "..." : prices['gender-reveal']?.priceFormatted || "R$ 29,90"}
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">Pagamento único</p>
                </div>
              </div>

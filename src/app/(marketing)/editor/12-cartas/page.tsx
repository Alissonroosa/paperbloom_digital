...
export default function Editor12CartasPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header - z-index menor que o preview modal */}
      <header className="border-b bg-white/50 backdrop-blur-sm sticky top-0 z-40">
        <div className="container flex h-14 md:h-16 items-center justify-between px-3 md:px-8 max-w-screen-2xl mx-auto">
          <Link 
            href="/" 
            className="font-serif text-lg md:text-xl font-bold tracking-tight text-text-main"
          >
            Paper Bloom
          </Link>
          <div className="text-sm text-muted-foreground hidden md:block">
          ...
          <Link href="/">
            <Button size="sm" variant="ghost" className="min-h-[40px] min-w-[40px]">
              Cancelar
            </Button>
          </Link>
        </div>

...
/**
 * Step 3: Momentos de Amor (Cards 5-8)
 * Edit cards for celebration and romance moments
 * 
 * @see Requirements 4.2, 4.3, 4.4, 4.5, 4.7
 */
export function Step4Cards5to8() {
  ...
  // Cards 5-8 (indices 4-7)
  const momentCards = cards.slice(4, 8);
  ...
  return (
    <FullscreenStep
      emoji="💝"
      title="Cartas para Momentos de Amor"
      subtitle="Celebre o amor e as conquistas juntos"
      showProgress={true}
      showBackLink={false}
      showDemoLink={true}
    ...
    >
      <div className="w-full max-w-2xl mx-auto space-y-6">
        <p className="text-center text-gray-600 text-sm">
          Essas 4 cartas são para os momentos mais doces! 
          Aniversários, conquistas, ou simplesmente para dizer "eu te amo". 💕
        </p>

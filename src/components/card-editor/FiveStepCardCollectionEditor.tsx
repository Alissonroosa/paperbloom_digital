...
export function FiveStepCardCollectionEditor({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Main Content */}
      <main className="flex-1 container px-3 md:px-8 py-4 md:py-8 max-w-screen-2xl mx-auto">
        {/* Auto-save indicator */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8">
          ...
          <div className="lg:col-span-6 xl:col-span-6">
            <div className="bg-white rounded-xl shadow-sm border p-3 md:p-6 space-y-4 md:space-y-6">
                        ...
                        <React.Fragment key={idx}>
                          ...
                          <button
                            ...
                            className={`
                              ...
                              w-7 h-7 sm:w-8 sm:h-8 rounded-full font-semibold text-[10px] sm:text-xs
                              transition-all duration-200
                              ${
                                isCompleted
                                  ? 'bg-secondary text-white hover:bg-text-accent cursor-pointer'
                                  : isActive
                                  ? 'bg-text-accent text-white ring-2 ring-primary/30'
              ...
              <div className="space-y-1 md:space-y-2">
                <h2 className="text-lg md:text-2xl font-serif font-bold text-text-main">
              ...
              {/* Navigation Buttons */}
              <div className="flex justify-between pt-4 md:pt-6 border-t gap-2 md:gap-3">
                <Button
                  variant="outline"
                  onClick={goToPreviousStep}
                  disabled={currentStep === 0 || isProcessing || isFinalizingState}
                  className="min-h-[44px] min-w-[44px] text-sm md:text-base"
                  aria-label="Voltar para etapa anterior"
                >
                  <ArrowLeft className="w-4 h-4 mr-1 md:mr-2" aria-hidden="true" />
                ...
                {currentStep < STEPS.length - 1 ? (
                  <Button
                    ...
                    className="min-h-[44px] min-w-[44px] text-sm md:text-base flex-1 sm:flex-none"
                    aria-label="Avançar para próxima etapa"
                  >
                    Próximo
                    <ArrowRight className="w-4 h-4 ml-1 md:ml-2" aria-hidden="true" />
                  </Button>
                ) : (
                  <Button
                  ...
                  >
                    {isFinalizingState ? (
                      <>
                        <Loader2 className="mr-1 md:mr-2 h-4 w-4 animate-spin" aria-hidden="true" />
          ...
          <div className="lg:col-span-6 xl:col-span-6">
            <div className="sticky top-6 space-y-4">
              <CardCollectionPreview
                ...
                senderName={senderName || collection?.senderName}
                recipientName={recipientName || collection?.recipientName}

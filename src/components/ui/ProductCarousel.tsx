...
export function ProductCarousel() {
    ...
    // Preços dinâmicos
    const messagePrice = prices['message']?.priceFormatted || 'R$ 19,90';
    const cardCollectionPrice = prices['card-collection']?.priceFormatted || 'R$ 29,90';

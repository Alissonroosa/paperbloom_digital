...
_ENV_SEARCH_PATHS = [
    os.path.expanduser("~/.claude/skills/meta-ads-paperbloom/.env"),
...
def init_api():
    ...
    if not token:
        ...
        print("  Crie o arquivo ~/.claude/skills/meta-ads-paperbloom/.env com:", file=sys.stderr)
        print('  META_ADS_TOKEN="seu-token-aqui"', file=sys.stderr)
        print("", file=sys.stderr)
        print("  Ou rode: /meta-ads-paperbloom setup", file=sys.stderr)
        sys.exit(1)

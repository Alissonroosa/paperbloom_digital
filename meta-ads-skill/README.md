...
Skill de Meta Ads para Claude Code, configurada para a **Paperbloom (Paper Bloom)**. Gerencia campanhas no Facebook e Instagram via SDK oficial da Meta (`facebook-business`).
...
cp -r . ~/.claude/skills/meta-ads-paperbloom/
...
python3 ~/.claude/skills/meta-ads-paperbloom/scripts/setup.py
```
...
Tutorial completo: Consultar `references/setup-meta-app.md`
...
**Paper Bloom Digital** — Presentes digitais personalizados

Produtos anunciados:
- Mensagem Digital (ver preco atual em `references/produtos-paperbloom.md`)
- 12 Cartas (ver preco atual em `references/produtos-paperbloom.md`)
- Revelacao Virtual (ver preco atual em `references/produtos-paperbloom.md`)
